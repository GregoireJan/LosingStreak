...
app.layout = html.Div(children=[
    html.H1(
        children='Stopping opponent losing streaks',
        style={
            'textAlign': 'left'}),
    html.Br(),
    html.Br(),
    html.Div(children='Check which football teams are "best" at stopping opponent losing streaks (2 previously lost games) by selecting the country/season/league you are interested in (it can take few seconds to pop up):', style={
        'textAlign': 'left'}),
    html.Div([
        html.Div([
